...
2. Install python3.10 and make a python virtual environment in the root directory (if not already present).
```bash
...
| image_file_path | split | mctv_label_file_path | labels_corneas |
|-----------------|-------|----------------------|----------------|
| /path/to/image1 | train | /path/to/label1.mat  | /path/to/cornea_labels1.csv |
| /path/to/image2 | test  | /path/to/label2.mat  | /path/to/cornea_labels2.csv |
| /path/to/image3 | train | /path/to/label3.mat  | /path/to/cornea_labels3.csv |
